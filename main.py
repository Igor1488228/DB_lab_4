...
def get_user_query(test_coll: Collection, filename):
    """Варіант 8: Порівняти середній бал ЗНО з математики у кожному регіоні у 2020 та 2019 роках
    ...
    with open(filename, "w") as csvfile:
        csq_writer = csv.DictWriter(csvfile, fieldnames=["year", "region", "mathAverageMark"])
...
def insert_data_into_collections(iteration, test_coll: Collection, last_row_coll: Collection,
    ...
    try:
        ...
        LOG.info(f"База данних впала: {e}")
        raise e
    return 0
